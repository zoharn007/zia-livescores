pipeline {
    ...
    environment {
        ...
        WORKSPACE = "/home/ec2-user/workspace/BackendBuild"
        WORKSPACE1 = "/var/lib/jenkins/workspace/zia_dev/BackendBuild"
        WORKSPACE3 = "/home/ec2-user/workspace/zia_dev/BackendBuild"
    }
    stages {
        stage('Build') {
            steps {
